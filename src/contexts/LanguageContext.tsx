...
const translations = {
  de: {
    ...
    "services.labDesc": "Zuverlässige Fahrten zu Laborterminen",
    "services.dialysis": "Dialysefahrten",
    "services.dialysisDesc": "Regelmäßige Fahrten zur Dialysebehandlung",
    "services.reha": "Kur- & Rehafahrten",
    "services.rehaDesc": "Transport zu Kur- und Rehabilitationseinrichtungen",
    "services.hospital": "Krankenhaus- & Klinikfahrten",
    "services.hospitalDesc": "Sichere Beförderung zu Krankenhaus und Kliniken",
    "services.chemo": "Chemo- & Strahlentherapie",
    "services.chemoDesc": "Sensible Fahrten zur Krebsbehandlung",
    "services.companion": "Patienten- & Begleitfahrten",
    "services.companionDesc": "Mit oder ohne Begleitperson ans Ziel",
    ...
    // Pricing
    "pricing.badge": "Flughafen Frankfurt",
    "pricing.title": "Festpreise zum Flughafen",
    "pricing.subtitle": "Transparente Festpreise für alle Fahrten zum Frankfurt Flughafen.",
    "pricing.from": "Von (Ort)",
    "pricing.carL": "Ffm Flughafen L (Auto)",
    "pricing.carXXL": "Ffm Flughafen XXL (Auto)",
    "pricing.nightSurcharge": "+10€ Nachtzuschlag",
    "pricing.otherRoutes": "Preise anderer Strecken auf Anfrage",

    // Booking extras
    "booking.category": "Taxi-Kategorie",
    "booking.categoryNormal": "Normal",
    "booking.categoryRollstuhl": "Rollstuhl",
    "booking.categoryFlughafen": "Flughafen",
    "booking.categorySchulfahrt": "Schulfahrt",
    "booking.rollstuhlDetails": "Rollstuhl-Details",
    "booking.rollstuhlTyp": "Rollstuhl-Typ",
    "booking.rollstuhlSitzend": "Sitzend",
    "booking.rollstuhlTragestuhl": "Mit Tragestuhl",
    "booking.kvApproval": "KV-Genehmigung vorhanden?",
    "booking.paymentExempt": "Zuzahlungsbefreit?",
    "booking.yes": "Ja",
    "booking.no": "Nein",
    "booking.selectOption": "Bitte wählen",
    "booking.vehicleType": "Fahrzeugtyp",
    "booking.upTo4": "Bis 4 Personen",
    "booking.upTo8": "Bis 8 Personen",
    "booking.fixedPrice": "Festpreis",
    "booking.bookingMethod": "Buchung per",
    "booking.submitWhatsApp": "Per WhatsApp absenden",
    "booking.submitEmail": "Per E-Mail absenden",

    // Impressum extras
    "impressum.taxId": "Umsatzsteuer-ID",
  ...
  en: {
    ...
    "services.labDesc": "Reliable rides to laboratory appointments",
    "services.dialysis": "Dialysis Rides",
    "services.dialysisDesc": "Regular transport to dialysis treatment",
    "services.reha": "Spa & Rehabilitation Trips",
    "services.rehaDesc": "Transport to spa and rehab facilities",
    "services.hospital": "Hospital & Clinic Transfers",
    "services.hospitalDesc": "Safe transportation to hospitals and clinics",
    "services.chemo": "Chemotherapy & Radiation Therapy",
    "services.chemoDesc": "Sensitive rides for cancer treatment",
    "services.companion": "Patient & Companion Rides",
    "services.companionDesc": "Travel with or without accompaniment",
    ...
    // Pricing
    "pricing.badge": "Frankfurt Airport",
    "pricing.title": "Fixed Airport Prices",
    "pricing.subtitle": "Transparent fixed prices for all trips to Frankfurt Airport.",
    "pricing.from": "From (Location)",
    "pricing.carL": "Ffm Airport L (Car)",
    "pricing.carXXL": "Ffm Airport XXL (Car)",
    "pricing.nightSurcharge": "+10€ Night Surcharge",
    "pricing.otherRoutes": "Other route prices on request",

    // Booking extras
    "booking.category": "Taxi Category",
    "booking.categoryNormal": "Normal",
    "booking.categoryRollstuhl": "Wheelchair",
    "booking.categoryFlughafen": "Airport",
    "booking.categorySchulfahrt": "School Ride",
    "booking.rollstuhlDetails": "Wheelchair Details",
    "booking.rollstuhlTyp": "Wheelchair Type",
    "booking.rollstuhlSitzend": "Seated",
    "booking.rollstuhlTragestuhl": "With Carry Chair",
    "booking.kvApproval": "KV Approval Available?",
    "booking.paymentExempt": "Payment Exempt?",
    "booking.yes": "Yes",
    "booking.no": "No",
    "booking.selectOption": "Please select",
    "booking.vehicleType": "Vehicle Type",
    "booking.upTo4": "Up to 4 persons",
    "booking.upTo8": "Up to 8 persons",
    "booking.fixedPrice": "Fixed Price",
    "booking.bookingMethod": "Book via",
    "booking.submitWhatsApp": "Send via WhatsApp",
    "booking.submitEmail": "Send via Email",

    // Impressum extras
    "impressum.taxId": "VAT ID",
